...
final public class AllListItemsPresenter: NSObject, ListPresenterType {
    ...
    /**
        The index of the first completed item within the list's items. `nil` if there is no complete list item
        in the presented list items.
    */
    public var indexOfFirstCompletedListItem: Int? {
    ...
    */
    public func canMoveListItem(listItem: ListItem, toIndex: Int) -> Bool {
        ...
        let firstCompleteListItemIndex = indexOfFirstCompletedListItem
