/*
    ...
    Abstract:
                ...
                The `ColoredTextRowController` class defines a simple interface that the `WatchListsInterfaceController` uses to represent a `List` object in the table.
...
/**
    ...
    `WatchListsInterfaceController` controller's `WKInterfaceTable` property.
*/
