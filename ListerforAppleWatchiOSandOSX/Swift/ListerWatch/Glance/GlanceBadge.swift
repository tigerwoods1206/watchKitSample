...
class GlanceBadge {
    ...
    */
    var groupBackgroundImage: UIImage {
        ...
        drawCompletedItemsCountInCurrentContext()
    ...
    */
    private var rangeLength: Int {
        ...
        return Int(normalizedPercentage * 360)
    }
    ...
    */
    ...
    func drawCompletedItemsCountInCurrentContext() {
        ...
        itemsRemainingText.drawInRect(completeRect.integerRect, withAttributes: completeAttributes)
